			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						_context.next = 3;
						return _BetOrder.HistoryBet.find({ 'owner.player': req.user._id, 'closedAt': { $gte: (0, _moment2.default)().subtract(weekNum, 'w').startOf('isoWeek'), $lte: (0, _moment2.default)().subtract(weekNum, 'w').endOf('isoWeek') } });
